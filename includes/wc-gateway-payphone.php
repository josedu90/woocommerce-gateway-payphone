...
//        }
    ...
    function process_payment($order_id) {
        ...
        try {
            include(dirname(__FILE__) . '/wc-gateway-payphone-process.php');
    ...
    public function process_refund($order_id, $amount = null, $reason = '') {
        ...
        try {
            include(dirname(__FILE__) . '/wc-gateway-payphone-refund.php');
    ...
    function payphone_response($request) {
        ...
        if ($order_id != null) {
            ...
            try {
                ...
                include(dirname(__FILE__) . '/wc-gateway-payphone-response.php');
